...
namespace PS.HireRocks.Data.Database
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual int InsertAccountType(Nullable<long> userAccountTypeId, string userId)
        {
            var userAccountTypeIdParameter = userAccountTypeId.HasValue ?
                new ObjectParameter("UserAccountTypeId", userAccountTypeId) :
                new ObjectParameter("UserAccountTypeId", typeof(long));
        ...
        public virtual ObjectResult<WorkerHourlyReportByWorkerId_Result> WorkerHourlyReportByWorkerId(string workerId, Nullable<System.DateTime> date, Nullable<long> jobId)
        {
            var workerIdParameter = workerId != null ?
                new ObjectParameter("WorkerId", workerId) :
                new ObjectParameter("WorkerId", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<WorkerHourlyReportByWorkerId_Result>("WorkerHourlyReportByWorkerId", workerIdParameter, dateParameter, jobIdParameter);
        }
        ...
        public virtual int UpdateContractForWorker(Nullable<long> contractId, Nullable<decimal> fixedRate, Nullable<decimal> hourlyRate, Nullable<decimal> weeklyHourLimit, Nullable<bool> isEndingContract, string endReason, Nullable<decimal> skill, Nullable<decimal> quality, Nullable<decimal> availability, Nullable<decimal> deadline, Nullable<decimal> communication, Nullable<decimal> cooperation, string comment, string userId)
        {
            var contractIdParameter = contractId.HasValue ?
                new ObjectParameter("ContractId", contractId) :
                new ObjectParameter("ContractId", typeof(long));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateContractForWorker", contractIdParameter, fixedRateParameter, hourlyRateParameter, weeklyHourLimitParameter, isEndingContractParameter, endReasonParameter, skillParameter, qualityParameter, availabilityParameter, deadlineParameter, communicationParameter, cooperationParameter, commentParameter, userIdParameter);
        }
    }
}
